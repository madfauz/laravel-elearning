<x-app-layout>
    <div class="w-[90%] md:w-1/2 mx-auto my-12">
        ...
        <form id="updateCourse" method="POST" action="{{ route('course.update', $course->course_id) }}"
           ...
           file:bg-green-500 file:text-white hover:file:bg-green-700 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                ...
                <div id="cover_preview_wrapper" class="mt-2">
                    ...
                    <img id="cover_preview" src="{{ $course->cover_url }}" alt="Thumbnail Preview"
        ...
        @if (Route::has('course.update'))
            <div class="flex items-center justify-end mt-4">
                ...
                <x-confirm-modal id="save_confirmation" message="Are you sure you want to update Course?" okLabel="Save"
                    cancelLabel="Cancel" :url="route('course.update', $course->course_id)" method="PUT" formId="updateCourse" />
            </div>
        @endif
    </div>
